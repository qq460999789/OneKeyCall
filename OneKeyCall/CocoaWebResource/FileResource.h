...
//-------设为可选-------MM
//the file size by the index
-(NSString *)fileSizeAtIndex:(NSInteger)index;

//the file Create time by the index
-(NSString *)fileCreateTimeAtIndex:(NSInteger)index;
//the file name displayed on page
-(NSString *)fileDisplayNameAtIndex:(NSInteger)index;
@end
